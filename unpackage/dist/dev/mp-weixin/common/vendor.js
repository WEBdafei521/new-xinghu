...
// 订单列表
exports.updata_wxnum = updata_wxnum;var orderListApi = function orderListApi(parmas) {
  return _Ajax.default.get('/api/master/order/list', parmas);
};
// 订单列表
exports.orderListApi = orderListApi;var confirmReceipt = function confirmReceipt(parmas) {
  return _Ajax.default.get('/api/master/order/confirmReceipt', parmas);
};
// 支付
exports.confirmReceipt = confirmReceipt;var payOrderApi = function payOrderApi(parmas) {
  return _Ajax.default.post('/api/master/unipay/prePayOrder', parmas);
};
// 订单详情 //失败 
exports.payOrderApi = payOrderApi;var orderInfoApi = function orderInfoApi(parmas) {
  return _Ajax.default.post('/api/master/order/info', parmas);
};
// 地址列表
...
// }
// 选择默认地址
exports.goodsListApi = goodsListApi;var addressDefault = function addressDefault(parmas) {
